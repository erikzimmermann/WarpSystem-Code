package de.codingair.warpsystem.spigot.nitrado.warpgui;
...
import de.codingair.warpsystem.spigot.nitrado.warpgui.pages.*;
...
public class WarpPanel extends GUI {
    ...
    public static final String PREFIX = COLOR_NITRADO + "WarpPanel §8» §7";
